 ...
 * takes were made with ElevenLabs, voice Mustafa Silici, eleven_multilingual_v2).
...
const voice = process.env.ELEVENLABS_VOICE_ID || "fg8pljYEn5ahwjyOQaro"; // Mustafa Silici
